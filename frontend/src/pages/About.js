                           ...
                           <CardDeck className="deck">
                              ...
                              <Card className = "card" text = "white">
                                 ...
                                 <ListGroup text = "white" className="list-group-flush listgroup">
                                    ...
                                    <ListGroupItem className = "listgroup" action href="https://speakerdeck.com/cpichardo622/stonk-alert" rel="noopener noreferrer" target="_blank">Speaker Deck Presentation</ListGroupItem>
                                 </ListGroup>
